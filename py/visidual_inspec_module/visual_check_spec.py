######
##Note: this script is just copy from visual_check_spec.ipynb
#####
...
print('lya_hits size is',plate_list.size)
...
for i in range(plate_list.size):
    ...
    plt.close(fig)
    print(out_png,'---{} image-----finished!'.format(i))